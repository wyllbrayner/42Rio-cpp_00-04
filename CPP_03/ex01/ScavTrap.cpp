...
{
	std::cout << "ScavTrap: Default Construtor called with name " << name \
		<< std::endl;
	this->_name = name;
	this->_hit_points = 100;
	this->_energy_points = 50;
...
ScavTrap::~ScavTrap()
{
	std::cout << "ScavTrap: Deconstructor called by " << this->_name << std::endl;
	return;
}
...
void	ScavTrap::guardGate( void )
{
	if (this->_hit_points > 0)
	{
		...
		std::cout << "ScavTrap " << this->_name << " He doesn't have enough "\
